...
public final class MessagesGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<crypto.Request,
      crypto.Response> getSubscribeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "subscribe",
      requestType = crypto.Request.class,
      responseType = crypto.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<crypto.Request,
      crypto.Response> getSubscribeMethod() {
    io.grpc.MethodDescriptor<crypto.Request, crypto.Response> getSubscribeMethod;
      ...
      synchronized (MessagesGrpc.class) {
        if ((getSubscribeMethod = MessagesGrpc.getSubscribeMethod) == null) {
          MessagesGrpc.getSubscribeMethod = getSubscribeMethod =
              io.grpc.MethodDescriptor.<crypto.Request, crypto.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "subscribe"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  crypto.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  crypto.Response.getDefaultInstance()))
  ...
  public static abstract class MessagesImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void subscribe(crypto.Request request,
        io.grpc.stub.StreamObserver<crypto.Response> responseObserver) {
  ...
  public static final class MessagesBlockingStub extends io.grpc.stub.AbstractBlockingStub<MessagesBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<crypto.Response> subscribe(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SUBSCRIBE:
          serviceImpl.subscribe((crypto.Request) request,
              (io.grpc.stub.StreamObserver<crypto.Response>) responseObserver);
          break;
        default:
  ...
  private static abstract class MessagesBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return crypto.Crypto.getDescriptor();
    }
