...
{
    default float lineLength(Line l)
    {
        return lineLength(l, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float lineLength(Line l, java.util.Map<String, String> context)
    {
        return _iceI_lineLengthAsync(l, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> lineLengthAsync(Line l)
    {
        return _iceI_lineLengthAsync(l, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> lineLengthAsync(Line l, java.util.Map<String, String> context)
    {
        return _iceI_lineLengthAsync(l, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_lineLengthAsync(Line iceP_l, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "lineLength", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     Line.ice_write(ostr, iceP_l);
                 }, istr -> {
                     float ret;
                     ret = istr.readFloat();
                     return ret;
    ...
    default float[] squareSequence(float[] s)
    {
        return squareSequence(s, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float[] squareSequence(float[] s, java.util.Map<String, String> context)
    {
        return _iceI_squareSequenceAsync(s, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<float[]> squareSequenceAsync(float[] s)
    {
        return _iceI_squareSequenceAsync(s, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<float[]> squareSequenceAsync(float[] s, java.util.Map<String, String> context)
    {
        return _iceI_squareSequenceAsync(s, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<float[]> _iceI_squareSequenceAsync(float[] iceP_s, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<float[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "squareSequence", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeFloatSeq(iceP_s);
                 }, istr -> {
                     float[] ret;
    ...
    default java.util.Map<java.lang.String, java.lang.Integer> countLetters(String sentence)
    {
        return countLetters(sentence, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default java.util.Map<java.lang.String, java.lang.Integer> countLetters(String sentence, java.util.Map<String, String> context)
    {
        return _iceI_countLettersAsync(sentence, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.util.Map<java.lang.String, java.lang.Integer>> countLettersAsync(String sentence)
    {
        return _iceI_countLettersAsync(sentence, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.util.Map<java.lang.String, java.lang.Integer>> countLettersAsync(String sentence, java.util.Map<String, String> context)
    {
        return _iceI_countLettersAsync(sentence, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.util.Map<java.lang.String, java.lang.Integer>> _iceI_countLettersAsync(String iceP_sentence, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.util.Map<java.lang.String, java.lang.Integer>> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "countLetters", null, sync, null);
        f.invoke(true, context, null, ostr -> {
